...
func main() {
	...
	httpHandleFunc("/", root)
	httpHandleFunc(login_cgi, login)
	httpHandleFunc(logout_cgi, logout)
	// Handlers de graficos
	httpHandleFunc("/encoderStatNow.cgi", encoderStatNow)
	httpHandleFunc("/playerStatNow.cgi", playerStatNow)
	httpHandleFunc("/consultaFecha.cgi", consultaFecha)
	httpHandleFunc("/firstFecha.cgi", firstFecha)
	httpHandleFunc("/getMonthsYears.cgi", getMonthsYears)
	httpHandleFunc("/giveFecha.cgi", giveFecha)
	httpHandleFunc("/zeroFields.cgi", zeroFields)
	httpHandleFunc("/formatDaylyhtml.cgi", formatDaylyhtml)
	httpHandleFunc("/createGraf.cgi", createGraf)
	httpHandleFunc("/firstMonthly.cgi", firstMonthly)
	httpHandleFunc("/graficosMonthly.cgi", graficosMonthly)
	httpHandleFunc("/play.cgi", play)
	httpHandleFunc("/publish.cgi", publish)
	httpHandleFunc("/onplay.cgi", onplay)
	httpHandleFunc("/getMonthsYearsAdmin.cgi", getMonthsYearsAdmin)
	httpHandleFunc("/putMonthlyAdmin.cgi", putMonthlyAdmin)
	httpHandleFunc("/putMonthlyAdminChange.cgi", putMonthlyAdminChange)
	httpHandleFunc("/editar_admin.cgi", editar_admin)
	httpHandleFunc("/editar_cliente.cgi", editar_cliente)
	httpHandleFunc("/user_admin.cgi", user_admin)
	httpHandleFunc("/changeStatus.cgi", changeStatus)
	httpHandleFunc("/nuevoCliente.cgi", nuevoCliente)
	httpHandleFunc("/borrarCliente.cgi", borrarCliente)
	httpHandleFunc("/buscarClientes.cgi", buscarClientes)
	httpHandleFunc("/totalMonths.cgi", totalMonths)
	httpHandleFunc("/totalMonthsChange.cgi", totalMonthsChange)
	httpHandleFunc("/hardware.cgi", gethardware)
