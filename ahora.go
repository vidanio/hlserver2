...
func play(w http.ResponseWriter, r *http.Request) {
	...
	video := fmt.Sprintf("<script src=\"http://domainplayers.org/js/hls.min.js\"></script><script src=\"http://domainplayers.org/js/html5play.min.js\"></script><video id=\"video_x890\" controls width=\"600\" height=\"409\"><source id=\"src_x890\">Your browser does not support HTML5 video. We recommend using <a href=\"https://www.google.es/chrome/browser/desktop/\">Google Chrome</a></video><script>var url = \"%s\";html5player(url, 0, \"video_x890\", \"src_x890\");</script>", stream)
